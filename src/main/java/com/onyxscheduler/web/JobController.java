...
/**
 * Main entry point for the onyx REST API (and job scheduling and managing). <p/> Here are hosted
 * all logic and configuration related to the API from documentation to mapping to proper requests,
 * responses, exception handling, etc.
 */
@RestController
@RequestMapping("/onyx")
